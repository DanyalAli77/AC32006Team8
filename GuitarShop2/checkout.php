...
// Check input errors before inserting in database
    if(empty($username_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql_order = "INSERT INTO orders (branchID, customerID, paymentID, orderDate, orderPrice, orderStatus) VALUES (1, ?,(SELECT MAX( paymentID ) FROM payment) ,NOW(), '$total', 'processing')";
